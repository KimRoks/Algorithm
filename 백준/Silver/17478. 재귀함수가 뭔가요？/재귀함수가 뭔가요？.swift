func solution(currentDepth: Int, maxDepth: Int) {
    let underLine = String(repeating: "____", count: currentDepth)
    ...
    if currentDepth == maxDepth {
        ...
        solution(currentDepth: currentDepth + 1, maxDepth: maxDepth)
    }
...
func main() {
    ...
    solution(currentDepth: 0, maxDepth: n)
}
